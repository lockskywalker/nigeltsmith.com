<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MobileMaster.master" CodeFile="MobileContact.aspx.cs" Inherits="MobileContact" %>
...
<asp:Content runat="server" ContentPlaceHolderID="bod">
    ...
    <div style="padding-left:10px;text-align:center; font-size:Large; color:#009adb; padding-top:20px;">
    <asp:Label runat="server" ForeColor="#009adb" Font-Bold="true" Font-Size="Large" Text="Contact Me"></asp:Label>
    <br />
    <br />
    <b>Phone: (910) 554-4127</b> <br />
    <b>Email: smithni12@students.ecu.edu</b> <br />
    <br />
    <asp:Label runat="server" ForeColor="#009adb" Font-Bold="true" Font-Size="XLarge" Text="Email Me"></asp:Label>
    </div>
    ...
    <asp:Panel runat="server" ID="emailpanel">
        ...
        <asp:TableRow>
            ...
            <asp:TableCell>
                <asp:TextBox Textmode="MultiLine" runat="server" ID="messagebox" Width="150px" Height="200px"></asp:TextBox>
