<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MobileMaster.master" CodeFile="MobileDefault.aspx.cs" Inherits="MobileDefault" %>
...
<asp:Content runat="server" ContentPlaceHolderID="bod">
    ...
    <h1>Welcome</h1> <br />
        ...
        <div style="font-size:30px; font-family:sans-serif;">
            <asp:Image runat="server" ImageUrl="~/images/welcome.png" Width="150px" />
